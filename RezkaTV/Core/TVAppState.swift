...
enum Tabs: String, CaseIterable, Identifiable {
    ...
    var label: String {
        switch self {
        case .home: String(localized: "key.home")
        case .search: String(localized: "key.search")
        case .categories: String(localized: "key.categories")
        case .collections: String(localized: "key.collections")
        case .bookmarks: String(localized: "key.bookmarks")
        case .watchingLater: String(localized: "key.watching_later")
        case .settings: String(localized: "key.settings")
        }
    }
